...
game_ws_manager = GameWebSocketConnectionManager()
game_manager = GameManager(game_repo=game_repo, game_engine=Engine(), front_end=game_ws_manager)
...
game_ws_router = get_game_ws_router(ws_connection_manager=game_ws_manager, game_manager=game_manager)
...
async def health_check():
    ...
    return {
        ...
        "active_connections": sum(len(players) for players in game_ws_manager.active_connections.values()),
    }

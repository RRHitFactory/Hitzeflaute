...
class GameSettings:
    ...
    def to_simple_dict(self) -> dict:
        ...
        return {
            ...
            "loads": self.loads.to_simple_dict(),
            "generators": self.generators.to_simple_dict(),
    ...
    def from_simple_dict(cls, simple_dict: dict) -> Self:
        ...
        return cls(
            ...
            loads=TechnologySettingsRepo.from_simple_dict(simple_dict["loads"]),
            generators=TechnologySettingsRepo.from_simple_dict(simple_dict["generators"]),
            transmission=TechnologySettingsRepo.from_simple_dict(simple_dict["transmission"]),
            ...
            map_area=Shape.from_simple_dict(simple_dict["map_area"]) if "map_area" in simple_dict else Shape.make_rectangle(bottom_left=Point(-30, -15), top_right=Point(30, 15)),
            max_assets_per_bus=simple_dict["max_assets_per_bus"] if "max_assets_per_bus" in simple_dict else 5,
            max_lines_per_bus=simple_dict["max_lines_per_bus"] if "max_lines_per_bus" in simple_dict else 5,
        )

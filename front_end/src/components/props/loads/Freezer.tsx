...
const Freezer: React.FC<FreezerProps> = ({ ownerColor, position, scale }) => {
  return (
    <g
    ...
    >
      ...
      <g className="ice-cream" filter="url(#shadow-freezer)">
        ...
        <path
          d="M 15,30 L 5,10 H 25 Z"
          fill="url(#coneGradient-freezer)"
          stroke="#ca8a04"
          strokeWidth="0.5"
        />
        {/* Detailed cross-hatch pattern */}
        <path
          d="M 8,16 L 22,16 M 11,22 L 19,22 M 14,28 L 16,28"
          stroke="#ca8a04"
          strokeWidth="0.3"
          opacity="0.5"
        />
        <path
          d="M 15,10 L 11,22 M 15,10 L 19,22"
          fill="none"
          stroke="#ca8a04"
          strokeWidth="0.3"
          opacity="0.5"
        ...
        <circle
          ...
          cy="5"
          r="5"
          fill="url(#scoopGlow-freezer)"
          opacity="0.4"
        />
        <path
          d="M 15 2 Q 13 4 15 6"
          fill="none"
          stroke="#e2e8f0"
          strokeWidth="0.3"
          opacity="0.6"
        ...
        {/* Detailed cross-hatch pattern */}
        <path
          d="M 38,16 L 52,16 M 41,22 L 49,22 M 44,28 L 46,28"
          stroke="#ca8a04"
          strokeWidth="0.3"
          opacity="0.5"
        />
        <path
          d="M 45,10 L 41,22 M 45,10 L 49,22"
          fill="none"
          stroke="#ca8a04"
          strokeWidth="0.3"
          opacity="0.5"

...
const Residential: React.FC<ResidentialProps> = ({ ownerColor, position }) => {
  return (
    <g 
      transform={`translate(${position.x - 25}, ${position.y - 45})`}
    ...
    >
      ...
      <g filter="url(#shadow-2d)">
        ...
        <rect x="35" y="0" width="4" height="10" fill="#475569" stroke="#334155" strokeWidth="0.5" />
        
        {/* 1. Building Body (Layered Rectangles) */}
        {/* Back Tier (subtle depth) */}
        <rect x="10" y="5" width="30" height="25" fill="#cbd5e1" stroke="#475569" strokeWidth="0.5" opacity="0.6" />
        {/* Main Body */}
        <rect x="5" y="10" width="40" height="30" fill="url(#wall-grad-2d)" stroke="#475569" strokeWidth="0.5" />

        {/* 2D Roof Line Accents */}
        <rect x="9" y="5" width="32" height="1" fill="#cbd5e1" stroke="#475569" strokeWidth="0.5" opacity="0.8" />
        <rect x="4" y="10" width="42" height="1" fill="#e2e8f0" stroke="#475569" strokeWidth="0.5" />

        {/* 2. Flat Gable Roof */}
        {/* Sub-roof line */}
        <path d="M 7 5 L 25 0 L 43 5 Z" fill="#c53030" stroke="#991b1b" strokeWidth="0.5" opacity="0.8" />
        {/* Main Roof */}
        <path d="M 2 10 L 25 0 L 48 10 Z" fill="url(#roof-grad-2d)" stroke="#991b1b" strokeWidth="0.5" />
        ...
        <path d="M 5 40 L 48 40 L 44 43 L 8 43 Z" fill="#4b5563" opacity="0.1" />
        ...
        {/* Door (centered) */}
        <rect x="13" y="24" width="10" height="14" fill="#6b7280" stroke="#475569" strokeWidth="0.5" />
        <circle cx="28" cy="32" r="0.5" fill="#e2e8f0" /> {/* handle */}

        {/* Window with Glowing Light (Pulsing household logic) */}
        <rect x="30" y="20" width="10" height="12" fill="#0f172a" stroke="#475569" strokeWidth="0.5" />
        <rect x="30" y="20" width="10" height="12" fill="#38bdf8" opacity="0.3"/> {/* cool glass tint */}
        <g className="house-light">
          <rect x="30" y="20" width="10" height="12" fill="#facc15" stroke="#475569" opacity="0.6"/>
        </g>
        
        {/* Window Panes (more defined) */}
        <line x1="35" y1="20" x2="35" y2="32" stroke="#475569" strokeWidth="0.5" />
        <line x1="30" y1="26" x2="40" y2="26" stroke="#475569" strokeWidth="0.5" />

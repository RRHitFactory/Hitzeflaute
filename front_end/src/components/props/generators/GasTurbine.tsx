  ...
  return (
    ...
    >
      ...
      <g filter="url(#shadow-2d)">
        ...
        <rect x="34" y="6" width="10" height="40" fill="url(#exhaust-grad-2d)" stroke="#1e293b" strokeWidth="0.5" />
        <ellipse cx="39" cy="6" rx="5" ry="1.5" fill="#0f172a" />

        {/* Smoke */}
        <g transform="translate(20, -40)">
          <circle cx="-10" cy="-10" r="13" fill="url(#smoke)" className="smoke" style={{ animationDelay: '0s' }} />
          <circle cx="-10" cy="-10" r="13"  fill="url(#smoke)" className="smoke" style={{ animationDelay: '0.4s' }} />
          <circle cx="-10" cy="-10" r="13"  fill="url(#smoke)" className="smoke" style={{ animationDelay: '0.9s' }} />
          <circle cx="-10" cy="-10" r="13"  fill="url(#smoke)" className="smoke" style={{ animationDelay: '1.1s' }} />
          <circle cx="-10" cy="-10" r="13"  fill="url(#smoke)" className="smoke" style={{ animationDelay: '1.4s' }} />
        </g>

        {/* 2. Air Intake Filter House (Left) */}
        <rect x="6" y="20" width="12" height="26" fill="url(#intake-grad-2d)" stroke="#334155" strokeWidth="0.5" />
        <rect x="5" y="18" width="14" height="2" fill="#94a3b8" stroke="#334155" strokeWidth="0.5" />
        
        {/* Louvers / Vents on Intake */}
        <line x1="8" y1="24" x2="16" y2="24" stroke="#1e293b" strokeWidth="1" opacity="0.6" />
        <line x1="8" y1="28" x2="16" y2="28" stroke="#1e293b" strokeWidth="1" opacity="0.6" />
        <line x1="8" y1="32" x2="16" y2="32" stroke="#1e293b" strokeWidth="1" opacity="0.6" />
        <line x1="8" y1="36" x2="16" y2="36" stroke="#1e293b" strokeWidth="1" opacity="0.6" />

        {/* 3. Main Turbine Enclosure (Center) */}
        <rect x="18" y="32" width="16" height="14" fill="url(#turbine-grad-2d)" stroke="#334155" strokeWidth="0.5" />
        
        {/* Turbine Structural Ribs */}
        <line x1="22" y1="32" x2="22" y2="46" stroke="#64748b" strokeWidth="1" />
        <line x1="26" y1="32" x2="26" y2="46" stroke="#64748b" strokeWidth="1" />
        <line x1="30" y1="32" x2="30" y2="46" stroke="#64748b" strokeWidth="1" />
        ...
        <g transform="translate(26, 36)">
          <circle cx="0" cy="0" r="3.5" fill="url(#combustion-glow-2d)" className="combustion-pulse" />
          <circle cx="0" cy="0" r="1.5" fill="#fcd34d" className="combustion-pulse" />
        </g>
      </g>
    </g>
  );

...
const Coal: React.FC<CoalProps> = ({ ownerColor, position, scale }) => {
  return (
    <g
    ...
    >
      ...
      {/* Coal Mound */}
      <path
        d="M 2 44 L 6 36 L 10 38 L 14 34 L 19 44 Z"
        fill="url(#coal-grad)"
      />
      {/* Slanted Conveyor Belt */}
      <path
        d="M 12 40 L 24 22 L 27 24 L 15 42 Z"
        fill="#334155"
        stroke="#1e293b"
        strokeWidth="0.5"
      />

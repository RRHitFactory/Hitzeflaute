...
const Ccgt: React.FC<CcgtProps> = ({ ownerColor, position }) => {
  return (
    <g 
      transform={`translate(${position.x - 30}, ${position.y - 40})`}
    ...
    >
      ...
      <g transform="translate(20, -40)">
          <circle cx="-10" cy="-10" r="13" fill="url(#smoke)" className="steam-puff" style={{ animationDelay: '0s' }} />
          <circle cx="-10" cy="-10" r="13"  fill="url(#smoke)" className="steam-puff" style={{ animationDelay: '0.4s' }} />
          <circle cx="-10" cy="-10" r="13"  fill="url(#smoke)" className="steam-puff" style={{ animationDelay: '0.9s' }} />
          <circle cx="-10" cy="-10" r="13"  fill="url(#smoke)" className="steam-puff" style={{ animationDelay: '1.1s' }} />
          <circle cx="-10" cy="-10" r="13"  fill="url(#smoke)" className="steam-puff" style={{ animationDelay: '1.4s' }} />
        </g>
      
      {/* 1. Base Platform (Shows Owner Color) */}
      <path d="M-4 40 L 56 40 L 50 46 L 2 46 Z" fill={ownerColor} opacity="0.9" />
      <path d="M-4 40 L 56 40 L 56 41 L -4 41 Z" fill="#ffffff" opacity="0.3" />

      {/* 2. HRSG Exhaust Stack */}
      <rect x="8" y="4" width="4" height="18" fill="url(#metal-grad)" stroke="#475569" strokeWidth="0.5" />
      ...
      {/* 4. Main Turbine Hall */}
      <rect x="2" y="22" width="30" height="18" fill="url(#metal-grad)" stroke="#475569" strokeWidth="0.5" />
      {/* Pitched Roof */}
      <path d="M 2 22 L 17 14 L 32 22 Z" fill="url(#roof-grad)" stroke="#64748b" strokeWidth="0.5" />
      {/* Structural Ribs */}
      <line x1="8" y1="22" x2="8" y2="40" stroke="#64748b" strokeWidth="0.5" />
      <line x1="14" y1="22" x2="14" y2="40" stroke="#64748b" strokeWidth="0.5" />
      <line x1="20" y1="22" x2="20" y2="40" stroke="#64748b" strokeWidth="0.5" />
      <line x1="26" y1="22" x2="26" y2="40" stroke="#64748b" strokeWidth="0.5" />
      ...
      <rect x="24" y="34" width="10" height="6" rx="1" fill="#334155" stroke="#1e293b" strokeWidth="0.5" />
      ...
      <g transform="translate(29, 32)">
        <circle cx="0" cy="0" r="4.5" fill="url(#electric-glow)" className="spark-pulse" />

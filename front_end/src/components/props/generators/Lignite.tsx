  ...
  return (
    ...
    >
      ...
      <g filter="url(#shadow-2d)">
        ...
        <rect x="30" y="6" width="12" height="40" fill="url(#heavy-stack-2d)" stroke="#44403c" strokeWidth="0.5" />
        {/* Stack Top Rim */}
        <ellipse cx="36" cy="6" rx="6" ry="1.5" fill="#292524" />

        {/* Heavy Lignite Smoke Billows */}
        <g transform="translate(36, 4)">
          <circle cx="0" cy="0" r="7" fill="url(#dirty-smoke-2d)" className="sluggish-smoke" style={{ animationDelay: '0s' }} />
          <circle cx="-2" cy="-3" r="8" fill="url(#dirty-smoke-2d)" className="sluggish-smoke" style={{ animationDelay: '0.2s' }} />
          <circle cx="2" cy="-1" r="6" fill="url(#dirty-smoke-2d)" className="sluggish-smoke" style={{ animationDelay: '0.4s' }} />
          <circle cx="2" cy="-5" r="9" fill="url(#dirty-smoke-2d)" className="sluggish-smoke" style={{ animationDelay: '0.5s' }} />
          <circle cx="2" cy="-8" r="6" fill="url(#dirty-smoke-2d)" className="sluggish-smoke" style={{ animationDelay: '0.8s' }} />
          <circle cx="2" cy="0" r="5" fill="url(#dirty-smoke-2d)" className="sluggish-smoke" style={{ animationDelay: '0.9s' }} />
          <circle cx="2" cy="-5" r="6" fill="url(#dirty-smoke-2d)" className="sluggish-smoke" style={{ animationDelay: '1.1s' }} />
          <circle cx="2" cy="-7" r="9" fill="url(#dirty-smoke-2d)" className="sluggish-smoke" style={{ animationDelay: '1.3s' }} />
          <circle cx="2" cy="-5" r="8" fill="url(#dirty-smoke-2d)" className="sluggish-smoke" style={{ animationDelay: '1.5s' }} />
          <circle cx="2" cy="-4" r="6" fill="url(#dirty-smoke-2d)" className="sluggish-smoke" style={{ animationDelay: '1.6s' }} />
        </g>

        {/* 2. Main Boiler Building (Layered Rectangles for 2D Depth) */}
        {/* Back Tier */}
        <rect x="18" y="22" width="18" height="24" fill="#78716c" stroke="#44403c" strokeWidth="0.5" />
        {/* Front Tier */}
        <rect x="12" y="28" width="20" height="18" fill="url(#warm-boiler-2d)" stroke="#44403c" strokeWidth="0.5" />
        ...
        {/* Enclosed Conveyor */}
        <path d="M 10 38 L 18 26 L 21 28 L 13 40 Z" fill="#57534e" stroke="#292524" strokeWidth="0" />
        {/* Lignite Mound */}
        <path d="M 2 46 L 6 36 L 10 38 L 14 34 L 18 46 Z" fill="url(#lignite-grad-2d)" />
        ...
        <rect x="12" y="34" width="20" height="1" fill="#ffffff" opacity="0.3" />

        {/* 6. Ember Glowing Furnace Vent */}
        <rect x="20" y="40" width="8" height="4" rx="1" fill="#1c1917" />
        <circle cx="24" cy="42" r="3.5" fill="url(#ember-glow-2d)" className="ember-burn" />

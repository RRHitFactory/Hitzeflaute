...
const Wind: React.FC<WindProps> = ({ ownerColor, position }) => {
  return (
    <g 
    ...
    >
      ...
      <path d="M 23 44 L 26 10 L 28 10 L 31 44 Z" fill="url(#tower-grad-wind)" />
      ...
      <path d="M 25.5 16 L 28.5 16 L 28.6 18 L 25.4 18 Z" fill={ownerColor} opacity="0.9" />

      {/* 4. Nacelle (Generator Housing - pointing backwards/right) */}
      <rect x="25" y="7" width="10" height="4.5" rx="2" fill="url(#nacelle-grad)" stroke="#94a3b8" strokeWidth="0.5" />
      ...
      <g className="rotor-spin">
        {/* Blade 1 (Top) */}
        <path d="M 26 9 L 25 4 L 26 -12 L 27 -14 L 28 -12 L 29 4 L 28 9 Z" fill="url(#blade-grad)" stroke="#94a3b8" strokeWidth="0.25" />
        ...
        {/* Rotor Hub / Spinner */}
        <ellipse cx="27" cy="10" rx="2.5" ry="2.5" fill="#ffffff" stroke="#cbd5e1" strokeWidth="0.5" />
        {/* Center Owner Cap */}

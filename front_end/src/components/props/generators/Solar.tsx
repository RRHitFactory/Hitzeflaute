...
const Solar: React.FC<SolarProps> = ({ ownerColor, position, scale }) => {
  return (
    <g
    ...
    >
      ...
      <rect
        ...
        width="4"
        height="30"
        fill="url(#metal-grad-solar)"
        rx="1"
      />
      <path
        d="M 12 40 L 23 10 Q 25 8 27 10 L 38 40"
        fill="none"
        stroke="#64748b"
        strokeWidth="1"
      />
      <rect x="12" y="10" width="30" height="2" fill={ownerColor} rx="0.5" />{" "}
      {/* Main axis accent */}
      ...
      <g transform="translate(0, 0)">
        <path
          d="M-4 -2 L0 -8 L4 -2 L0 0 Z"
          fill="url(#glint-pulse-solar)"
          className="traveling-glint"
          style={{ animationDelay: "0.s" }}
        />
        <path
          d="M10 2 L-14 -2 L18 2 L14 6 Z"
          fill="url(#glint-pulse-solar)"
          className="traveling-glint"

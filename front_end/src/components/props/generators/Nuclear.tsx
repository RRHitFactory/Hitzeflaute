  ...
  return (
    ...
    >
      ...
      <g transform="translate(38, 2)">
        <circle cx="-10" cy="-10" r="13" fill="url(#pure-steam)" className="clean-plume" style={{ animationDelay: '0s' }} />
        <circle cx="-10" cy="-10" r="16" fill="url(#pure-steam)" className="clean-plume" style={{ animationDelay: '0.4s' }} />
        <circle cx="-10" cy="-10" r="18" fill="url(#pure-steam)" className="clean-plume" style={{ animationDelay: '1.2s' }} />
        <circle cx="-10" cy="-10" r="12" fill="url(#pure-steam)" className="clean-plume" style={{ animationDelay: '1.7s' }} />
        <circle cx="-10" cy="-10" r="10" fill="url(#pure-steam)" className="clean-plume" style={{ animationDelay: '2s' }} />
      </g>
      ...
      />
      {/* 2.5D Tower Opening */}
      <ellipse cx="38" cy="4" rx="9" ry="2" fill="#475569" stroke="#94a3b8" strokeWidth="0.5" />
      <ellipse cx="38" cy="4" rx="7.5" ry="1.5" fill="#1e293b" />

      {/* 3. Auxiliary Reactor Hall (Middle Layer) */}
      <rect x="18" y="28" width="16" height="16" fill="url(#reactor-hall-grad)" stroke="#94a3b8" strokeWidth="0.5" />
      {/* 2.5D Flat Roof */}
      <path d="M 18 28 L 24 24 L 40 24 L 34 28 Z" fill="#cbd5e1" stroke="#94a3b8" strokeWidth="0.5" />
      {/* Structural Ribs */}
      <line x1="22" y1="28" x2="22" y2="44" stroke="#94a3b8" strokeWidth="0.5" />
      <line x1="26" y1="28" x2="26" y2="44" stroke="#94a3b8" strokeWidth="0.5" />
      <line x1="30" y1="28" x2="30" y2="44" stroke="#94a3b8" strokeWidth="0.5" />

      {/* 4. Glowing Reactor Vent (Cherenkov Radiation) */}
      <rect x="23" y="34" width="8" height="4" rx="1" fill="#0f172a" />
      <circle cx="27" cy="36" r="4" fill="url(#cherenkov-glow)" className="reactor-pulse" />
      <rect x="24" y="35" width="6" height="2" fill="#67e8f9" opacity="0.9" className="reactor-pulse" />
      ...
      <path d="M 4 20 Q 14 24 24 20" fill="none" stroke="#94a3b8" strokeWidth="0.5" opacity="0.6" />
      <line x1="14" y1="9" x2="14" y2="44" stroke="#94a3b8" strokeWidth="0.5" opacity="0.5" />

      {/* 6. Player Ownership Accent Stripe (Curved around Dome) */}
      <path d="M 4 34 Q 14 36 24 34 L 24 37 Q 14 39 4 37 Z" fill={ownerColor} opacity="0.9" />
      <path d="M 4 34 Q 14 36 24 34 L 24 35 Q 14 37 4 35 Z" fill="#ffffff" opacity="0.4" />

      {/* 7. Nuclear Trefoil Symbol */}
      <g transform="translate(14, 25) scale(0.25)" fill="#334155" stroke="#f8fafc" strokeWidth="1">
        {/* Glowing backdrop for symbol */}
        <circle cx="0" cy="0" r="14" fill="#f8fafc" stroke="none" opacity="0.7" />
        <circle cx="0" cy="0" r="10" fill="none" stroke="#334155" strokeWidth="2" />
        {/* Trefoil Wedges */}

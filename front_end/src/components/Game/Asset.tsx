...
const AssetComponent: React.FC<AssetProps> = ({
    ...
    const canAfford = !isPurchasable || (onPurchase && asset.minimum_acquisition_price <= playerMoney)
    ...
    const handleBidClick = () => {
        if (!onBid) return
        const newBidPrice = prompt(`Enter new bid price for ${getAssetTitle()}:`, asset.bid_price.toString())
